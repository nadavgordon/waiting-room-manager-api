...
export class ApplyIndexesAndCascadePolicies1748748956908
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex(
      'room_players',
      new TableIndex({
        name: 'IDX_7d92a61295ed0e6378aeb15c12',
        columnNames: ['roomId'],
      }),
    );
    await queryRunner.createIndex(
      'room_players',
      new TableIndex({
        name: 'IDX_6669fb46bff7bd4b933df4e3d9',
        columnNames: ['userId'],
      }),
    );
    await queryRunner.createIndex(
      'room_players',
      new TableIndex({
        name: 'IDX_b14bdf73f02a7ac02d7d363e85',
        columnNames: ['status'],
      }),
    );
    ...
    await queryRunner.createIndex(
      'rooms',
      new TableIndex({
        name: 'IDX_12a78d090c7a8d44fc2ca37420',
    ...
    await queryRunner.createIndex(
      'rooms',
      new TableIndex({
        name: 'IDX_ffd12d5e703ed4027ebd41df44',
        columnNames: ['status'],
      }),
    );
    await queryRunner.createIndex(
      'rooms',
      new TableIndex({
        name: 'IDX_6c939085068c5539bad393be6b',
        columnNames: ['hostId'],
      }),
    );
    ...
    await queryRunner.createIndex(
      'users',
      new TableIndex({
        name: 'IDX_fe0bb3f6520ee0469504521e71',
    ...
    await queryRunner.dropForeignKey(
      'room_players',
      'FK_7d92a61295ed0e6378aeb15c121',
    ); // Assuming this is the existing FK name
    ...
    await queryRunner.dropForeignKey(
      'room_players',
      'FK_6669fb46bff7bd4b933df4e3d9d',
    ); // Assuming this is the existing FK name
    await queryRunner.createForeignKey(
      'room_players',
      new TableForeignKey({
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropIndex(
      'room_players',
      'IDX_b14bdf73f02a7ac02d7d363e85',
    );
    await queryRunner.dropIndex(
      'room_players',
      'IDX_6669fb46bff7bd4b933df4e3d9',
    );
    await queryRunner.dropIndex(
      'room_players',
      'IDX_7d92a61295ed0e6378aeb15c12',
    );
  }
}
