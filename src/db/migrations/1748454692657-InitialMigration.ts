...
export class InitialMigration1748454692657 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "room_players" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "roomId" uuid NOT NULL, "userId" uuid NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', CONSTRAINT "PK_fa8e2bcf2f068c20f4c3e05ab5f" PRIMARY KEY ("id"))`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "room_players" ADD CONSTRAINT "FK_7d92a61295ed0e6378aeb15c121" FOREIGN KEY ("roomId") REFERENCES "rooms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    // `FK_6669fb46bff7bd4b933df4e3d9d`: `room_players.userId` references `users.id`.
    await queryRunner.query(
      `ALTER TABLE "room_players" ADD CONSTRAINT "FK_6669fb46bff7bd4b933df4e3d9d" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "rooms" DROP CONSTRAINT "FK_6c939085068c5539bad393be6b9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "room_players" DROP CONSTRAINT "FK_6669fb46bff7bd4b933df4e3d9d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "room_players" DROP CONSTRAINT "FK_7d92a61295ed0e6378aeb15c121"`,
    );
